...
<body>
	...
	<div class="side-nav-panel-right">
		<ul id="slide-out-right" class="side-nav side-nav-panel collapsible">
			...
			<li><a href="/Goods/login"><i class="fa fa-sign-in"></i>Login</a></li>
			<li><a href="/Goods/register"><i class="fa fa-user-plus"></i>Register</a></li>
		</ul>
	</div>
	<!-- end side nav right-->
				...
				<div class="row">
					<form class="col s12">
						<div class="input-field">
							<input type="text" class="validate" id ="name" placeholder="USERNAME" required>
						</div>
						<div class="input-field">
							<input type="password" class="validate" id ="pwd" placeholder="PASSWORD" required>
						</div>
						<a href=""><h6>Forgot Password ?</h6></a>
						<a href="javascript:;" class="btn button-default" id="login">LOGIN</a>
					</form>
				</div>
			</div>
		</div>
...
$(function(){
        ...
        $("#login").click(function(){
            ...
            $.ajax({
                type:'post',
                url:"{{url('logindo')}}",
                data:{u_name:u_name,u_pwd:u_pwd,_token:'{{csrf_token()}}'},
                dataType:'json'
            }).done(function (res) {
                if(res==1){
						alert('登陆成功');
